...
@Getter
@Setter
@TableName("sys_role_admin_menu_relation")
@ApiModel(value = "SysRoleAdminMenuRelation对象", description = "角色_管理系统菜单关联表")
public class SysRoleAdminMenuRelation implements Serializable {
